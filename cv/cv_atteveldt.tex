...
students I supervise(d), e.g. on using Large Language Models in communicatino research (Moritz Laurer) news algorithms and diversity (Nicolas Mattis); digital tracking and filter bubbles (Felicia Loecherbach); the role of media logic in recent election campaigns (Janet Takens); the
