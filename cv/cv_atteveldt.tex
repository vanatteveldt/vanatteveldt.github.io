...
% Edit tex and/or bib files
% pdflatex cv_atteveldt; biber cv_atteveldt; pdflatex cv_atteveldt; pdflatex cv_atteveldt
% cp cv_atteveldt.pdf ../files
% Commit and push
...
Wouter van Atteveldt, December 2025
\end{center}
%\setmainfont
...
\simpleresumeitem{E-mail}{wouter.van.atteveldt@vu.nl}
\simpleresumeitem{Home page}{https://vanatteveldt.com}
...
I acquired various grants to study
susbtantive and methodological aspect of political communication,
including a Horizon Europe grant and multiple NWO grants (VENI, OC, JEDS) as project leader
and various grants as collaborator or (co-)PI.
This
resulted in a number of substantive collaborations and articles in the best-cited journals in the
field, including Political Analysis, Journal of Communication, and Political Communication.
I currently have an h-index of 35 with over 6,700 citations (Google Scholar).

\hspace{2em} I strongly believe science should contribute to society,
and have lead a number of relevant projects for amongst others the Dutch Parliament,
the Dutch Media Authority, and the Dutch Journalism Fund.

\hspace{2em} My methodological work have been disseminated to a broad audience of social science scholars,
as R packages and as part of the AmCAT text analysis infrastructure that I developed during my PhD project and that
is used in teaching and research projects at various universities.
% As an indication of the use of
...
students I supervise(d), e.g. on using Large Language Models in communication research (Moritz Laurer);
news algorithms and diversity (Nicolas Mattis); digital tracking and filter bubbles (Felicia Loecherbach); the role of media logic in recent election campaigns (Janet Takens); the
...
and co-founded and chair the VU Societal Analytics lab as well as the CCS.Amsterdam virtual collaborative research lab.
I am editor-in-chief and co-founder of the Q1-ranked open access journal Computational Communication Research.
}
...
\item Gabriella Bollici Moreno (co-promotor), started December 2024 on \textit{automatic analysis of political memes}
\item Zeve Sanderson (promotor; external), started Septemer 2022 on \textit{Belief in online (mis)information}
\item Moritz Laurer (promotor; external), defended in 2024 on \textit{Transfer Learning for Computational Social Science}
\item Nicolas Mattis (promotor), defended in 2024 on \textit{Rethinking News Algorithms}
...
\newcommand{\money}{
  ...
  \resumeitem{2024}{ERC Horizon Europe}{WHAT-IF: Advanced Simulations for Testing the Effect of the Information Environment on the Functioning of Democracy (Lead PI; 3.4M, together with many others). \url{https://what-if-horizon.eu}}
