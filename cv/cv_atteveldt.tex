...
% to add
% phd committee gerold schneider and peter vd besselaer
...
Wouter van Atteveldt, June 3, 2021
\end{center}
%\setmainfont
...
I acquired various grants (NWO VENI, OC; Digging into Data; Joint E-science/Data Science, H2020) to study
...
field, including Political Analysis, Journal of Communication, and Political Communication. I currently have an h-index of 20 with over 2,350 citations (Google Scholar).
...
students I supervise(d): news algorithms and diversity (Nicolas Mattis); news sharing on social media (Mickey Steijaert); digital tracking and filter bubbles (Felicia Loecherbach); the role of media logic in recent election campaigns (Janet Takens); the
...
I am also editor-in-chief and co-founder of the open access journal Computational Communication Research.
}
...
\item Moritz Laurer (promotor), started September 2021 on \textit{Transfer Learning for Computational Social Science}
\item Nicolas Mattis (promotor), started September 2020 on \textit{Rethinking News Algorithms}
\item Felicia Loecherbach (promotor), started July 2018 on \textit{Tracking the Filter Bubble}, 8-month paper approved
\item Christian Erwich (co-promotor) started his Ph.D. research in September 2015  on using natural language techniques  for interpreting bible texts (defense planned 2021-01-07, promotor: prof. Wido van Peursen).
...
\item 2019-current: Programme Director of VU master and bachelor program Communication Science. Responsible for BA curriculum review and development of international track. 
...
\item  developed and taught B.Sc. level courses `Social Media Analytics', `Seminar on Public Opinion and Communication', `Framing in Politics and Economics', and `Media in the Public Domain'
...
\item Member of the FSW Research Assessment Board (2021 -- present)
\item Member of the Advisory Board, \emph{Tech tegen Corona / Meldpunt Desinformatie}
...
\item Founding editor-in-chief, Computational Communication Research (ISSN 2665-9085).
